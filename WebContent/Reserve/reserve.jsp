       ...
       <div class="top_icon" style="margin-left: 340px; margin-right: 10px;" id="menulabel">
            ...
            <div class="mb_div">
               <ul id="mb_table">
                    ...
                    <a href="/hotel/Reserve/reserve.jsp"><li class="yud select">预订</li></a>
    ...
    <div class="menu fontYaHei">
        <div id="scrollable">
            ...
            <div class="items">
                ...
                <li class="select"><span data-url="/Book/Index.html">预订</span><em></em></li></ul>
                <br clear="all">
            </div>
        </div>
    </div>
    <!--end-->
    <iframe src="/hotel/ReserveRoomController/queryAllByPage" id="main" name="main" scrolling="auto" width="100%" height="451" frameborder="0"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
...
<!-- 新增预订 -->
   <div id="div1" class="white_content pwin" style="cursor: pointer; width: 900px; height: 450px; top: 68.5px; left: 150px; display: none;">
 		<iframe src="/hotel/ReserveRoomController/queryroomtype" name="win" scrolling="yes" style="float: left;" height="450" frameborder="0" width="100%"></iframe>
...
<!-- 预订转入住界面 -->
   <div id="div3" class="white_content pwin" style="cursor: pointer; width: 900px; height: 550px; top: 50px; left: 180px; display: none;">
    ...
    <!-- 补打订单界面 -->
   <div id="div4" class="white_content pwin" style="cursor: pointer; width: 900px; height: 450px; top: 50px; left: 180px; display: none;">
