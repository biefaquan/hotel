...
<body>
    <!--入住弹出窗口-->
    <form id="myadd" action="/hotel/RegistrationInforController/add1" target="_top" method="post" onsubmit="return Checked()">
                ...
                <li>
                    ...
                    <select name="r.r_id" style="width: 140px; margin-right: 40px; display: inline;" id="RoomTypeId">
                    	<c:forEach items="${rr.rnlist }" var="rn">
                    		<option value="${rn.r.r_id }">${rn.r.r_roomnum }</option>
                    	</c:forEach>
                    </select></li>
            ...
            <div id="divZF">
                <ul>
                    <li>
                        ...
                        <option value="现金">现金</option><option value="银行卡">银行卡</option><option value="网上支付">网上支付</option><option value="微信支付">微信支付</option><option value="支付宝支付">支付宝支付</option><option id="op01" style="display: none;" value="挂账">挂账</option></select>
                    </li>
                    <li>
