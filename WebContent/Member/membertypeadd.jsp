...
<body>
    <!--楼层弹出窗口-->
    <form action="/hotel/MemberTypeController/add" target="_top" method="post">
    <div class="louceng">
        <div class="line">添加会员类型</div>
        <ul>
            <li>
                <label><b style="color: red;">*</b>会员类型：</label><input name="mt_name" maxlength="10"  type="text"/></li>
            <li>
            	<label><b style="color: red;">*</b>折扣率：</label><input name="mt_discountrate" maxlength="10"  type="text"/>
            </li>
            <li>
