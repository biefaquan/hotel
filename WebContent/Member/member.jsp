...
<body>
       ...
       <div class="top_icon" style="margin-left: 340px; margin-right: 10px;" id="menulabel">
            ...
            <div class="mb_div">
                <ul id="mb_table">
                    ...
                    <a href="/hotel/Member/member.jsp"><li class="vip select">会员</li></a>
    ...
    <div class="menu fontYaHei">
        <div id="scrollable">
            ...
            <div class="items">
                ...
                <li class="select"><span data-url="/memberrequest.aspx">会员</span><em></em></li></ul>
                <br clear="all">
            </div>
        </div>
    </div>
    <!--end-->
    <iframe src="/hotel/MemberController/queryAllByPage" id="main" name="main" scrolling="auto" width="100%" height="468" frameborder="0"></iframe>
    <!--底部-->
        <div class="footer">
        <div class="fl">
            <ul class="first">
    ...
    <div class="white_content pwin" style="cursor: pointer; width: 700px; height: 650px; top: -23px; left: 333px; display: none;"><iframe src="index_2.html" name="win" scrolling="yes" style="float: left;" width="100%" height="650" frameborder="0"></iframe>
        <!--<div class="louceng">
        </div>-->
    ...
    <div class="white_content pwin2" style="z-index: 1004; cursor: pointer; width: 862px; height: 250px; top: 177px; left: 252px; display: none;"><iframe src="index_3.html" name="win" scrolling="yes" style="float: left;" width="100%" height="250" frameborder="0"></iframe>
        <!--<div class="louceng">
        </div>-->
    ...
    <div class="black_overlay pwin2_black" style="z-index: 1003; display: none;"></div>

    <div class="white_content paymentwin" style="z-index: 1006; cursor: pointer; width: 412px; height: 250px; top: 177px; left: 477px; display: none;"><iframe src="index_4.html" name="win" scrolling="yes" style="float: left;" width="100%" height="250" frameborder="0"></iframe>
        <!--<div class="louceng">
        </div>-->
...
<!-- 添加会员界面隐藏 -->
<div id="div1" class="white_content pwin" style="cursor: pointer; width: 700px; height: 350px; top: 100px; left: 280px; display: none;">
     <iframe id="iframe2" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
     <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 修改会员界面隐藏 -->
<div id="div2" class="white_content pwin" style="cursor: pointer; width: 700px; height: 350px; top: 100px; left: 280px; display: none;">
     <iframe id="iframe1" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
     <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 充值会员界面隐藏 -->
<div id="div3" class="white_content pwin" style="cursor: pointer; width: 820px; height: 500px; top: 30px; left: 280px; display: none;">
     <iframe src="/hotel/Member/memberaddmoney.jsp" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
     <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 升级会员界面隐藏 -->
<div id="div4" class="white_content pwin" style="cursor: pointer; width: 820px; height: 500px; top: 30px; left: 280px; display: none;">
     <iframe id="iframe3" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
     <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 会员挂失界面隐藏 -->
<div id="div5" class="white_content pwin" style="cursor: pointer; width: 820px; height: 400px; top: 70px; left: 280px; display: none;">
     <iframe src="/hotel/Member/memberloss.jsp" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
     <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 会员换卡界面隐藏 -->
<div id="div6" class="white_content pwin" style="cursor: pointer; width: 820px; height: 500px; top: 30px; left: 280px; display: none;">
     <iframe src="/hotel/Member/memberchange.jsp" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
     <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 会员退卡界面隐藏 -->
<div id="div7" class="white_content pwin" style="cursor: pointer; width: 820px; height: 400px; top: 70px; left: 280px; display: none;">
     <iframe src="/hotel/Member/memberdelete.jsp" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
     <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 会员类型添加界面隐藏 -->
<div id="div8" class="white_content pwin" style="cursor: pointer; width: 300px; height: 200px; top: 180px; left: 400px; display: none;">
     <iframe src="/hotel/Member/membertypeadd.jsp" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
     <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 会员类型修改界面隐藏 -->
<div id="div9" class="white_content pwin" style="cursor: pointer; width: 300px; height: 200px; top: 180px; left: 400px; display: none;">
     <iframe id="iframe4" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
     <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
