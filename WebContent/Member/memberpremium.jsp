...
<body>
	<form action="/hotel/MemberController/updatetype" target="_top" method="post" onsubmit="return IsOK()">
    <div class="vip_infor" style="width: 800px;">
        <div class="line">
            <div class="fl">会员升级</div>
        ...
        <div class="types" style="background: rgb(239, 239, 239) none repeat scroll 0% 0%; border: 1px solid rgb(221, 221, 221);">
            <ul>
                <li>
                    <label><b style="color: red;">*</b>升级类型：</label>
                    <select name="mt.mt_id" style="width: 100px;" class="txt" id="Paymethed">
        ...
        <div class="types">
            <ul style="float: right; width: 174px;">
                <li style="">
                    <input class="bus_add " value="确定升级" id="BtnSave" type="submit"></li>
