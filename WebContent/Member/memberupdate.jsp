...
<body>
    <!--楼层弹出窗口-->
   	<form action="/hotel/MemberController/update" target="_top" method="post" onsubmit="return IsOK()">
    <div class="vip_infor" style="width: 600px;">
        <div class="line">
            <div class="fl" id="divfa">会员信息修改</div>
        ...
        <div class="types" id="CAdd" style="display: block; margin-top: 0px;">
            <ul>
                <li>
                    ...
                    <input name="m_cardnum" value="${m.m_cardnum }" readonly="readonly" class="txt inps" id="MemberCardNo" maxlength="20" type="text">
                    <input name="m_id" value="${m.m_id }" type="hidden"/>
                    <input name="m_money" value="${m.m_money }" type="hidden"/>
                    <input name="m_date" value="<fmt:formatDate value='${m.m_date }' pattern='yyyy-MM-dd' />" type="hidden"/>
                    <input name="m_state" value="${m.m_state }" type="hidden"/>
                </li>
            </ul>
        </div>
        <!-- 
        ...
        <div class="types" style="background: rgb(239, 239, 239) none repeat scroll 0% 0%; border: 1px solid rgb(221, 221, 221); margin-top: 0px;">
            <ul>
                <li>
                    ...
                    <input name="c.c_name" value="${m.c.c_name }" class="txt inps" style="width: 100px;" id="Name" maxlength="20" type="text">
                    <input name="c.c_id" value="${m.c.c_id }" type="hidden"/>
                </li>
                <li>
                    <label>性别：</label>
                    <select name="c.c_sex" class="txt" style="width: 86px;" id="Sex">
                        <c:if test="${m.c.c_sex=='男' }">
                        <option value="男" selected="selected">男</option>
                        <option value="女">女</option>
                        </c:if>
                        <c:if test="${m.c.c_sex=='女' }">
                ...
                <li>
                    ...
                    <input name="c.c_idcard" value="${m.c.c_idcard }" class="inps txt" style="width: 100px; margin-right: 0px;" id="CardNo" maxlength="20" type="text">
                    
                </li>
                <li>
                    <label style="width: 75px;">会员类型：</label>
                    <input name="mt.mt_name" value="${m.mt.mt_name }" readonly="readonly" class="txt" id="CategoryId" onchange="CategoryType()" style="width: 86px;"/>
                    <input name="mt.mt_id" value="${m.mt.mt_id }" type="hidden"/>
                </li>
                <li>
                    <label style="width: 70px;">操作员：</label>
                    <input class="inps txt" style="width: 92px; margin-right: 0px;" readonly="readonly" id="CardNo" maxlength="20" value="${m.u.u_name }" type="text">
                    <input name="u.u_id" value="${m.u.u_id }" type="hidden"/>
                </li>
                <li>
                    <label style="width: 70px;"><b style="color: red;">*</b>手机号码：</label>
                    <input name="c.c_phone" value="${m.c.c_phone }" class="inps txt" style="width: 100px;" id="Phone" maxlength="11" type="text">
                </li>
                <li>
                    <label>生日：</label>
                    <input name="c.c_birthday" value="<fmt:formatDate value='${m.c.c_birthday }' pattern='yyyy-MM-dd' />" class="inps txt" style="width: 78px;" id="BirthDay" onclick="laydate()"  type="text">
                </li>
                
                <li style="width: 100%;">
                    <label style="width: 70px;">喜好：</label>
                    <input name="c.c_like" value="${m.c.c_like }" class="inps" style="width: 500px;" id="Love" maxlength="100" type="text">
                </li>
                <li style="width: 100%;">
                    <label style="width: 70px;">地址：</label>
                    <input name="c.c_adress" value="${m.c.c_adress }" class="inps" style="width: 500px;" id="Address" maxlength="100" type="text">
                </li>
                <li style="width: 100%;">
                    <label style="width: 70px;">备注：</label>
                    <input name="c.c_reward" value="${m.c.c_reward }" class="inps" style="width: 500px;" id="Remark" maxlength="100" type="text">
                    <!-- 民族 -->
                    <input name="c.c_nation" value="${m.c.c_nation }" type="hidden"/>
                </li>
            </ul>
        </div>
