...
<script type="text/javascript">
	...
	function IsOK() {
		...
		//验证充值金额
		var money=document.getElementById("PaymentAmount").value;
		if(money=="0"){
			alert("请填写充值金额！！");
			return false;
		}
...
<body>
	<form action="/hotel/MoneyRecordController/add" target="_top" method="post" onsubmit="return IsOK()">
    <div class="vip_infor" style="width: 800px;">
        <div class="line">
            <div class="fl">会员充值</div>
        ...
        <div class="types" style="margin: 0px;">
            <ul>
                <li>
                    ...
                    <input id="m_id" name="m.m_id" type="hidden"/>
                </li>
            </ul>
        </div>
        ...
        <div class="types" style="background: rgb(239, 239, 239) none repeat scroll 0% 0%; border: 1px solid rgb(221, 221, 221);">
            <ul>
                <li>
                    <label>支付方式：</label>
                    <select name="mr_paytype" style="width: 100px;" class="txt" id="Paymethed"><option value="现金">现金</option><option value="银行卡">银行卡</option><option value="微信支付">微信支付</option><option value="支付宝支付">支付宝支付</option></select>
                </li>
                <li>
                    <label><b style="color: red;">*</b>充值金额：</label>
                    <input name="mr_money" class="inps" style="width: 70px;" id="PaymentAmount" maxlength="6" value="0" type="text">
                    <label style="margin-right: 5px;">元</label></li>
                
                <li>
                    <label style="width: 60px;">操作员：</label>
                    <input class="inps" style="width: 75px;" id="TopAmount" readonly="readonly" value="${user.u_name }" type="text">
        ...
        <div class="types">
            <ul style="float: right; width: 174px;">
                <li style="">
                    <input class="bus_add " value="会员充值" id="BtnSave" type="submit"></li>
