...
<body>
	<form action="/hotel/MemberController/updatestate" target="_top" method="post" onsubmit="return IsOK()">
    <div class="vip_infor" style="width: 800px;">
        <div class="line">
            <div class="fl">会员挂失</div>
        ...
        <div class="types">
            <ul style="float: right; width: 174px;">
                <li style="">
                    <input class="bus_add " value="确定挂失" id="BtnSave" type="submit"></li>
