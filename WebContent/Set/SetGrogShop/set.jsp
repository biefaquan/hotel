...
<body>
       ...
       <div class="top_icon" style="margin-left: 340px; margin-right: 10px;" id="menulabel">
            ...
            <div class="mb_div">
                <ul id="mb_table">
                   ...
                   <a href="/hotel/Set/SetGrogShop/set.jsp"><li class="shezh select">设置</li></a>
    ...
    <div class="menu fontYaHei">
        <div id="scrollable">
            ...
            <div class="items">
                ...
                <li class="select"><span data-url="/Set/Set.html">设置</span><em></em></li></ul>
                <br clear="all">
            </div>
        </div>
    </div>
    <!--end-->
    <iframe src="/hotel/Set/SetGrogShop/index_1.jsp" id="main" name="main" scrolling="auto" width="100%" height="468" frameborder="0"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
    ...
    <div class="white_content pwin" style="cursor: pointer; width: 650px; height: 500px; top: 52px; left: 358px; display: none;"><iframe src="/hotel/Set/SetGrogShop/index_4.jsp" name="win" scrolling="yes" style="float:left;" width="100%" height="500" frameborder="0"></iframe>
        <!--<div class="louceng">
        </div>-->
