...
<link media="all" href="/hotel/css/set/index.css" type="text/css" rel="stylesheet">
...
<body>
    ...
    <!--end-->
    <iframe src="/hotel/Set/SetEmployee/index_1.jsp" id="main" name="main" scrolling="auto" width="100%" height="468" frameborder="0"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
