...
<link media="all" href="/hotel/css/set/setroom/index_2.css" type="text/css" rel="stylesheet">
</head>
<body>
    <div class="set_lf  fontYaHei">
        <a href="/hotel/Set/SetGrogShop/set.jsp" target="_top" id="a_company">酒店信息</a>
        <a href="/hotel/Set/SetRoom/setroom.jsp" target="_top" id="a_room" class="select">房间信息</a>
        <a onclick="CheckPower()">员工信息</a>
        <a href="/hotel/Set/SetAccount/setaccount.jsp" target="_top">账户管理</a>
