...
<body>
    ...
    <!--end-->
    <iframe src="/hotel/Set/SetPwd/index_1.jsp" id="main" name="main" scrolling="auto" width="100%" height="468" frameborder="0"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
    ...
    <div class="white_content pwin" style="cursor: pointer; width: 500px; height: 400px; top: 102px; left: 433px; display: none;"><iframe src="/hotel/Set/SetPwd/index_4.jsp" name="win" scrolling="yes" style="float: left;" width="100%" height="400" frameborder="0"></iframe>
        <!--<div class="louceng">
        </div>-->
