...
<body>
    <div class="glossymenu">
        <div class="caidan">
            ...
            <div id="dd4" class="submenu" contentindex="3c" style="display: block;">
                <ul id="xycenter">
                    <li class="lis" id="XY001"><a href="/hotel/Reports/AgreementCredit/agreementcredit.jsp" target="_top" style="cursor: pointer;" class="select">结算明细报表</a></li>
                </ul>
            </div>
