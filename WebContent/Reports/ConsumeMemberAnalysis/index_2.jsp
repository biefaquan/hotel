        ...
        <div class="caidan">
            ...
            <div id="dd1" class="submenu" contentindex="0c" style="display: none;">
                <ul id="cxcenter" style="height: 100px; overflow-y: auto; overflow-x: hidden;">
                    ...
                    <li class="lis" id="CX003">
                        <a href="/hotel/Reports/CashierDetail/cashierdetail.jsp" target="_top" style="cursor: pointer;">收银明细查询</a></li>
            ...
            <div id="dd3" class="submenu" contentindex="2c" style="display: block;">
                <ul id="hycenter">
                    ...
                    <li class="lis" id="HY003"><a href="/hotel/Reports/ConsumeMemberAnalysis/consumememberanalysis.jsp" target="_top" style="cursor: pointer;" class="select">会员消费报表</a></li>
