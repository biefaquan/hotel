...
<body>
    ...
    <div class="head" id="head">
       ...
       <div class="top_icon" style="margin-left: 340px; margin-right: 10px;" id="menulabel">
            <a id="btn_pre" style="cursor: pointer;"><img src="/hotel/img/roomrack/left.png" class="mb30" alt="" height="30" width="14"></a>
            <a id="btn_next" style="cursor: pointer;"><img src="/hotel/img/roomrack/right.png" class="mb30" alt="" height="30" width="14"></a>
            <div class="mb_div">
                <ul id="mb_table">
                    <a href="/hotel/RoomRack/roomrack.jsp"><li class="ftt select">房态图</li></a>
        ...
        <div id="scrollable">
            ...
            <div class="items">
                <ul style="position: absolute; width: 200000em; left: 0px;" class="scrollable_demo">
                    <li class="select"><span data-url="/FrontOp/RoomState.htm">房态图</span></li>
                </ul>
                <br clear="all">
            </div>
        </div>
    ...
    <!--end-->
    <iframe src="/hotel/RoomController/queryAll" id="main" name="main" scrolling="auto" height="468" frameborder="0" width="100%"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
...
<!-- 开房 -->
<div id="div1" class="white_content pwin" style="cursor: pointer; width: 900px; height: 550px; top: 50px; left: 180px; display: none;">
...
<!-- 预订转入住 -->
<div id="div2" class="white_content pwin" style="cursor: pointer; width: 900px; height: 550px; top: 50px; left: 180px; display: none;">
...
<!-- 结账 -->
<div id="div3" class="white_content pwin" style="cursor: pointer; width: 900px; height: 550px; top: 50px; left: 180px; display: none;">
...
<!-- 换房 -->
<div id="div4" class="white_content pwin" style="cursor: pointer; width: 900px; height: 300px; top: 100px; left: 180px; display: none;">
...
<!-- 续住 -->
<div id="div5" class="white_content pwin" style="cursor: pointer; width: 900px; height: 300px; top: 100px; left: 180px; display: none;">
     <iframe id="iframe5" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
      <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 修改客人信息 -->
<div id="div6" class="white_content pwin" style="cursor: pointer; width: 900px; height: 500px; top: 50px; left: 180px; display: none;">
     <iframe id="iframe6" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
      <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
<!-- 补交房租 -->
<div id="div7" class="white_content pwin" style="cursor: pointer; width: 900px; height: 550px; top: 50px; left: 180px; display: none;">
     <iframe id="iframe7" name="win" scrolling="yes" style="float: left;" height="550" frameborder="0" width="100%"></iframe>
      <div class="close" tag="pwin">
         <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
     </div>
</div>
