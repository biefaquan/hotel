...
<body>
    ...
    <div class="menu fontYaHei">
        <div id="scrollable">
            ...
            <div class="items">
                ...
                <li class="select"><span data-url="/team/TeamRoom.html">团队开房</span><em></em></li></ul>
                <br clear="all">
            </div>
        </div>
    </div>
    <!--end-->
    <iframe src="/hotel/TeamInforController/queryAllRoomType" id="main" name="main" scrolling="auto" height="468" frameborder="0" width="100%"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
    ...
    <div class="white_content pwin" style="cursor: pointer; width: 900px; height: 530px; top: 37px; left: 233px; display: none;"><iframe src="index_2.html" name="win" scrolling="yes" style="float: left;" height="530" frameborder="0" width="100%"></iframe>
        <!--<div class="louceng">
        </div>-->
