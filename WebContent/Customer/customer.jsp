...
<body>
       ...
       <div class="top_icon" style="margin-left: 340px; margin-right: 10px;" id="menulabel">
            ...
            <div class="mb_div">
               <ul id="mb_table">
                    ...
                    <a href="/hotel/Customer/customer.jsp"><li class="zhk select">住客</li></a>
    ...
    <div class="menu fontYaHei">
        <div id="scrollable">
            ...
            <div class="items">
                ...
                <li class="select"><span data-url="/Customer/Index.html">客人</span><em></em></li></ul>
                <br clear="all">
            </div>
        </div>
    </div>
    <!--end-->
    <iframe src="/hotel/RegistrationInforController/queryAllByPage" id="main" name="main" scrolling="auto" width="100%" height="468" frameborder="0"></iframe>
    <!--底部-->
       <div class="footer">
        <div class="fl">
            <ul class="first">
	...
	<!-- 补打入住单 -->
    <div id="div1" class="white_content pwin" style="cursor: pointer; width: 900px; height: 450px; top: 68.5px; left: 150px; display: none;">
 		<iframe id="iframe1" name="win" scrolling="yes" style="float: left;" height="450" frameborder="0" width="100%"></iframe>
 		<div class="close" tag="pwin">
            <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
        </div>
   </div>
   <!-- 入住单详细 -->
    <div id="div2" class="white_content pwin" style="cursor: pointer; width: 900px; height: 450px; top: 68.5px; left: 150px; display: none;">
 		<iframe id="iframe2" name="win" scrolling="yes" style="float: left;" height="450" frameborder="0" width="100%"></iframe>
 		<div class="close" tag="pwin">
            <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
        </div>
   </div>
