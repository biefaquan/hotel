...
<script type="text/javascript">
	$(function(){
		...
		$("#btnSave").click(function(){
			...
			$.ajax({
				url:"/hotel/ReturnPickController/addGoods",
				type:"POST",
				data:vform,
				dataType:"json",
				success:function(g){
	...
	function Delete(td) {
		...
		$.ajax({
			url:"/hotel/ReturnPickController/deleteGoods",
			type:"POST",
			data:"g_name="+g_name,
			dataType:"json",
			success:function(c){
	...
	function computeMoney(g) {
		...
		var rp_money = document.getElementById("rp_money");
		...
		rp_money.value=TotalAmount.innerText;
	}
	//删除商品时计算总金额
	...
	function changGoods() {
		...
		$.ajax({
			url:"/hotel/ReturnPickController/queryGList",
			type:"POST",
			data:"sh_id="+sh_id,
			dataType:"json",
	...
	function changUser() {
		...
		$.ajax({
			url:"/hotel/ReturnPickController/queryUser",
			type:"POST",
			data:"d_id="+d_id,
			dataType:"json",
...
<!--领料退货单-->
<form id="myadd" action="/hotel/ReturnPickController/add" target="_top" method="post">    
<div class="main" style="width: 1200px;">
        ...
        <ul class="in">
            <li>
                <label><b style="color: red;">*</b>退货部门：</label>
            ...
            <li><label><b style="color: red;">*</b>单据日期：</label><input name="rp_date" class="rili" value="<fmt:formatDate value='${date }' pattern='yyyy-MM-dd' />" onclick="laydate()" type="text"/></li>
            <li style="width: 570px;">
                <label>摘要：</label>
                <textarea id="ZY" name="rp_remark" maxlength="100"></textarea>
            </li>
            <li style="width: 570px;">
                <label>说明：</label>
                <textarea id="SM" name="rp_instruction" maxlength="100"></textarea>
            </li>
        </ul>
        <div class="rit">
                ...
                <table class="in" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            ...
                            <input id="rp_money" name="rp_money" value="0" type="hidden"/>
                      		<input name="rp_uid" value="${user.u_id }" type="hidden"/>
