...
<body>
    <div class="stock_set">
        <div class="fl">
            <iframe src="/hotel/Stock/StockChange/index_2.jsp" id="menu_left" name="menu_left" scrolling="yes" style="background: rgb(243, 243, 243) none repeat scroll 0% 0%; border-right: 1px solid rgb(221, 221, 221); display: block;" width="130" height="468" frameborder="0"></iframe>
        </div>
        <div class="fr">
            <iframe src="/hotel/StockChangeController/queryShS" id="set_main" name="set_main" scrolling="yes" style="display: block;" width="100%" height="468" frameborder="0"></iframe>
        </div>
    </div>
