    ...
    <div class="glossymenu">
        <div class="caidan">
                <div id="d1" class="select">
                    ...
                    <span id="s1" class="accordsuffix"><img src="/hotel/img/roomrack/minus.gif" class="statusicon"></span></a>
                </div>
                <div id="dd1" class="submenu" contentindex="0c" style="display: block;">
                    <ul>
                        <li class="lis"><a href="/hotel/Stock/PurchaseList/purchaselist.jsp" target="_top" class="select">进货单</a></li>
