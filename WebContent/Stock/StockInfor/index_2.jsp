    ...
    <div class="glossymenu">
        <div class="caidan">
                ...
                <div id="d2" class="select">
                    ...
                    <span id="s2" class="accordsuffix"><img src="/hotel/img/roomrack/plus.gif" class="statusicon"></span></a>
                </div>
                <div id="dd2" class="submenu" contentindex="1c" style="display: none;">
                    <ul>
                        ...
                        <li class="lis"><a href="/hotel/Stock/QueryStockChange/querystockchange.jsp" target="_top">库存调拨查询</a></li>
                ...
                <div id="d3" class="select">
                    ...
                    <span id="s3" class="accordsuffix"><img src="/hotel/img/roomrack/minus.gif" class="statusicon"></span></a>
                </div>
                <div id="dd3" class="submenu" contentindex="2c" style="display: block;">
                    <ul>
                        <li class="lis"><a href="/hotel/Stock/StockInfor/stockinfor.jsp" target="_top" class="select">仓库信息</a></li>
