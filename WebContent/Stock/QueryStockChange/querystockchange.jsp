...
<body>
    ...
    <!--end-->
    <iframe src="/hotel/Stock/QueryStockChange/index_1.jsp" id="main" name="main" scrolling="auto" width="100%" height="468" frameborder="0"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
...
<!-- 进货单详细 -->
<div id="div1" class="white_content pwin" style="cursor: pointer; width: 900px; height: 450px; top: 50px; left: 180px; display: none;">
