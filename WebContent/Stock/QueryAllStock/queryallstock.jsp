...
<body>
    ...
    <!--end-->
    <iframe src="/hotel/Stock/QueryAllStock/index_1.jsp" id="main" name="main" scrolling="auto" width="100%" height="468" frameborder="0"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
...
<!-- 编辑商品 -->
<div id="div1" class="white_content pwin" style="cursor: pointer; width: 600px; height: 300px; top: 150px; left: 350px; display: none;">
