...
<body>
    ...
    <!--end-->
    <iframe src="/hotel/Stock/Supplier/index_1.jsp" id="main" name="main" scrolling="auto" width="100%" height="468" frameborder="0"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
    ...
    <div class="white_content pwin" style="cursor: pointer; width: 500px; height: 420px; top: 92px; left: 433px; display: none;"><iframe src="index_4.html" name="win" scrolling="yes" style="float: left;" width="100%" height="420" frameborder="0"></iframe>
        <!--<div class="louceng">
        </div>-->
...
<!-- 添加供应商 -->
<div id="div1" class="white_content pwin" style="cursor: pointer; width: 500px; height: 500px; top: 30px; left: 433px; display: none;">
...
<!-- 编辑供应商 -->
<div id="div2" class="white_content pwin" style="cursor: pointer; width: 500px; height: 500px; top: 30px; left: 433px; display: none;">
