...
<script type="text/javascript">
	...
	function changGoods() {
		...
		$.ajax({
			url:"/hotel/StockListController/queryGList",
			type:"POST",
			data:"s_id="+s_id+"&sh_id="+sh_id,
			dataType:"json",
...
<!--退货单-->
<form id="myadd" action="/hotel/StockListController/addReturnList" target="_top" method="post">    
<div class="main" style="width: 1200px;">
        ...
        <ul class="in">
            <li>
                ...
                <select id="s_id" name="s.s_id" onchange="changGoods()">
            ...
            <li><label><b style="color: red;">*</b>单据日期：</label><input name="rl_date" class="rili" value="<fmt:formatDate value='${date }' pattern='yyyy-MM-dd' />" onclick="laydate()" type="text"/></li>
            <li style="width: 570px;">
                <label>摘要：</label>
                <textarea id="ZY" name="rl_remark" maxlength="100"></textarea>
            </li>
            <li style="width: 570px;">
                <label>说明：</label>
                <textarea id="SM" name="rl_instruction" maxlength="100"></textarea>
            </li>
        </ul>
        <div class="rit">
                ...
                <table class="in" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            ...
                            <input id="rl_money" name="rl_money" value="0" type="hidden"/>
                      		<input name="rl_uid" value="${user.u_id }" type="hidden"/>
