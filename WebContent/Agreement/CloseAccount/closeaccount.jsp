...
<body>
       ...
       <div class="top_icon" style="margin-left: 340px; margin-right: 10px;" id="menulabel">
            ...
            <div class="mb_div">
                <ul id="mb_table" style="left: 0px;">
                    ...
                    <a href="/hotel/Agreement/agreement.jsp"><li class="xieyi select">协议</li></a>
    ...
    <div class="menu fontYaHei">
        <div id="scrollable">
            ...
            <div class="items">
                ...
                <li class=""><span data-url="/ContractUnitRequest.aspx">协议单位</span><em></em></li><li class="select"><span data-url="http://conunit.jdd365.cn/Trade/ContractUnitTrade?ContractUnitId=3047">挂账结算</span><em></em></li></ul>
                <br clear="all">
            </div>
        </div>
    </div>
    <!--end-->
    <iframe src="/hotel/AgreementController/payCredit?a_id=${a_id }" id="main" name="main" scrolling="auto" height="451" frameborder="0" width="100%"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
    ...
    <div class="white_content pwin" style="cursor: pointer; width: 550px; height: 280px; top: 162px; left: 408px; display: none;"><iframe src="index_2.html" name="win" scrolling="yes" style="float: left;" height="280" frameborder="0" width="100%"></iframe>
        <!--<div class="louceng">
        </div>-->
    ...
    <div class="white_content pwin2" style="z-index: 1004; cursor: pointer; width: 700px; height: 300px; top: 178.5px; left: 324.5px; display: none;"><iframe src="index_3.html" name="win" scrolling="yes" style="float: left;" height="300" frameborder="0" width="100%"></iframe>
        <!--<div class="louceng">
        </div>-->
...
<!--去哪儿直连弹出框-->
<div class="swing_03div" style="position: fixed; top: 50%; left: 50%; margin-left: -300px; margin-top: -250px; z-index: 9999; display: none;">
    <img class="qunaershow" style="cursor: pointer;" src="/hotel/img/roomrack/swing_03.png" alt="">
    <a href="javascript:void(0);" class="swing_03a" style="position: absolute; top: 0px; right: 22px; display: block; width: 30px; height: 30px;">&nbsp;</a>
</div>
<div class="swing_03div_balck" style="position: fixed; left: 0px; top: 0px; bottom: 0px; right: 0px; background: rgb(0, 0, 0) none repeat scroll 0% 0%; opacity: 0.6; display: none;"></div>
