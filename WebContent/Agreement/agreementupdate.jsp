...
<form action="/hotel/AgreementController/update" target="_top" method="post" onsubmit="return Checked()">
<div class="protocol_m" style="width: 860px;">
    <div class="line">
        <div class="fl">修改协议单位信息</div>
        <div class="errortips" id="btnRead" style="font-size: 12px;"></div>
    </div>
    <ul class="first">
        <li>
        	<input name="a_id" value="${a.a_id }" type="hidden"/>
            <label><b style="color: red;">*</b>编号：</label><input name="a_cardnum" value="${a.a_cardnum }" id="UnitCode" maxlength="25" onblur="CheckUnitCode()" type="text">
            <label>单位名称：</label><input name="a_name" value="${a.a_name }" id="Name" maxlength="25" style="width: 300px;" type="text">
            <label>协议类别：</label>
            <select id="Agreement_id" name="at.at_id" style="width: 126px;">
        ...
        <li>
            <label><b style="color: red;">*</b>联系人：</label><input name="a_username" value="${a.a_username }" id="ContractName" maxlength="25" type="text">
            <label><b style="color: red;">*</b>电话：</label><input name="a_userphone" value="${a.a_userphone }" id="ContractPhone" maxlength="25" type="text">
            ...
            <input name="a_accountstate" id="accountstate" checked="checked" onclick="AllowAccount(this)" value="0" type="checkbox">
            </c:if>
            <label style="margin-right: 95px;" for="AllowBill">是否可挂账</label>
            <label>挂账限额：</label>
            <input name="a_accountmoney" value="${a.a_accountmoney }" id="MaxBillTotal" style="margin-right: 0px;" maxlength="10" placeholder="0或者空表示不限制" type="text">
        </li>
        <li>
            <label>地址：</label>
            ...
            <label>操作员：</label>
            <input value="${a.u.u_name }" readonly="readonly" style="margin-right: 0px;"maxlength="10"  type="text">
            <input name="u.u_id" value="${a.u.u_id }" type="hidden"/>
        </li>
        <li>
            <label>生效时间：</label><input id="startdate" name="a_startdate" value="<fmt:formatDate value='${a.a_startdate }' pattern='yyyy-MM-dd'/>" onclick="laydate()" type="text">
            <label>失效时间：</label><input id="enddate" name="a_enddate" value="<fmt:formatDate value='${a.a_enddate }' pattern='yyyy-MM-dd'/>" onclick="laydate()" type="text">
            <label>状态：</label>
            ...
            <input id="Radio_1" name="a_state" value="1" type="radio">
            <label style="text-align: left; width: 40px;" for="Radio_1">启用</label>
            <input id="Radio_2" name="a_state" checked="checked" value="0" type="radio"><label style="text-align: left;" for="Radio_2">停用</label>
            </c:if>
        </li>
        <li>
            <label>备注：</label><textarea name="a_reward" cols="20" id="Remark" maxlength="100" rows="2">${a.a_reward }</textarea>
        </li>
     </ul>
    <ul class="list">
    ...
    <div class="select_two" id="c02">
            <ul class="first" style="width: 98%; margin-left: 1%;">
                <li>
                    <label>房价折率：</label>
                    <input name="a_discountrate" value="${a.a_discountrate }" type="text"/>
