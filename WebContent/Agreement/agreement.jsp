...
<body>
    ...
    <div class="menu fontYaHei">
        <div id="scrollable">
            ...
            <div class="items">
                ...
                <li class="select"><span data-url="/ContractUnitRequest.aspx">协议单位</span><em></em></li></ul>
                <br clear="all">
            </div>
        </div>
    </div>
    <!--end-->
    <iframe src="/hotel/AgreementController/queryAll" id="main" name="main" scrolling="auto" width="100%" height="451" frameborder="0"></iframe>
    <!--底部-->
    <div class="footer">
        <div class="fl">
            <ul class="first">
    ...
    <div class="white_content pwin" style="cursor: pointer; width: 900px; height: 350px; top: 127px; left: 233px; display: none;"><iframe src="index_3.html" name="win" scrolling="yes" style="float: left;" width="100%" height="350" frameborder="0"></iframe>
        <!--<div class="louceng">
        </div>-->
...
<!-- 修改协议类别隐藏界面 -->
<div id="div1" class="white_content pwin" style="cursor: pointer; width: 300px; height: 200px; top: 200px; left: 400px; display: none;">
...
<!-- 添加协议信息隐藏界面 -->
<div id="div2" class="white_content pwin" style="cursor: pointer; width: 900px; height: 420px; top: 80px; left: 200px; display: none;">
	 <iframe src="/hotel/AgreementController/queryAt" name="win" scrolling="yes" style="float: left;" width="100%" height="500" frameborder="0"></iframe>
	 <div class="close" tag="pwin">
            <a onclick="CloseDiv(this)" style="cursor: pointer;">&nbsp;</a>
        </div>
</div>
<!-- 修改协议信息隐藏界面 -->
<div id="div3" class="white_content pwin" style="cursor: pointer; width: 900px; height: 420px; top: 80px; left: 200px; display: none;">
